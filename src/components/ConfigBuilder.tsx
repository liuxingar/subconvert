...
import { AlertCircle, ArrowDown, ArrowUp, Bot, Check, ChevronDown, Circle, Download, Eye, FileCode, FileCog, FileText, Filter, Gauge, HelpCircle, Heart, Key, Layers, Link2, ListTree, Loader2, Network, Plus, Radio, Route, Search, Server, Shield, SlidersHorizontal, Trash2, Wand2, X, Zap } from "lucide-react";
import { builtinTemplates, getTemplate } from "@/data/templates";
import { applyAdvancedSettings, defaultAdvancedSettings, type AdvancedProxyGroupDraft, type AdvancedSettings } from "@/lib/advancedConfig";
